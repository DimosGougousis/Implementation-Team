...
**Agent:** design-authority + integration-architect (cross-cutting)

## Purpose
Define the complete target-state for the Temenos Transact implementation including business capabilities, API catalogue, event channels, infrastructure, component model, security architecture, and technology standards.
