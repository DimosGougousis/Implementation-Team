...
**Primary Stage:** 8 — Hypercare
**Updated At:** 3
**CV Competency:** Post-Transformation Operating Model Design
**Agent:** operating-model

## Purpose
Design the post-go-live target operating model including run-state org structure, L1/L2/L3 support tiers, incident and change management processes, Temenos upgrade cadence, and the hypercare-to-steady-state handover plan.
