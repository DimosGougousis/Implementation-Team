...
**Agent:** data-migration-lead

## Purpose
Track data quality across all migration domains, define profiling and cleansing rules, maintain mapping specifications, enforce quality gates, and record rehearsal results.
