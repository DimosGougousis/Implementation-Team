...
**Agent:** design-authority

## Purpose
Capture all significant architectural decisions with full context, options considered, rationale, and consequences. Maintain traceability from requirements through decisions to implementation.
